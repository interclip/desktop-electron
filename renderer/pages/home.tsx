    ...
    <React.Fragment>
      ...
      <div className="w-full h-screen">
        <button
          ...
          className="rounded-xl z-20 fixed right-2 top-2 px-4 py-4 bg-white text-black transform duration-500 ease-in-out md:hover:scale-110 motion-reduce:transform-none m-2 focus:outline-none"
        >
          {menuOpened ? (
            <svg
              className="w-6 h-6"
